...
public class MyScrollView extends ScrollView implements OnTouchListener {
	...
	public static List<PaintingItem> items = new ArrayList<PaintingItem>();
	...
	public void loadMorePaintings(String category) {
		...
		if (DeviceUtil.hasSDCard()) {
			...
			AsycTaskWithWorkingUtil atu = new AsycTaskWithWorkingUtil(getContext(), Constant.Painting.PAINTING_LOAD, new OnPostWithWorkingInterface() {
	...
	private void addContainner(Bitmap bitmap, int conWidth, int conHeight,
		...
		if (mGalleryItem != null) {
			...
			mGalleryItem.setTag(R.string.orderOfCategory, category);
			Picasso.with(getContext()).load(Constant.Api.GET_PHOTO+map.get("up_actor_id")).error(R.drawable.empty_photo)
			...
			galleryItem.setTag(R.string.orderOfCategory, category);
			...
			items.add(new PaintingItem(map));
...
//		galleryItem.setPosition(galleryItemsSize);
